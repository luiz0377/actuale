...
class ConteudosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fotocapa' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'conteudos_ibfk_1' => ['type' => 'foreign', 'columns' => ['categoria_id'], 'references' => ['categorias', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'fotocapa' => 'Lorem ipsum dolor sit amet',
            'categoria_id' => 1
        ],
    ];
}
